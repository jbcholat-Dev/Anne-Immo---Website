...
| `avis-immodvisor/` | Capture ou export de tes avis Immodvisor + le lien de ta fiche | |
...
1. **Originaux seulement.** Le fichier tel qu'il sort de l'appareil photo ou du drone. Le site fabrique lui-même ses formats.
2. **Nomme simplement.** `maison-thonon-2026.jpg`, pas `IMG_4521.jpg`. Minuscules, tirets, sans accents.
3. **Une autorisation par personne citée et par bien photographié.** Un mot écrit (un e-mail suffit) du vendeur pour les photos, de l'acheteur pour son témoignage nominatif. Dépose-les dans le dossier de la story concernée.
